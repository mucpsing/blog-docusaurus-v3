 ...
 * @LastEditTime: 2024-02-21 09:32:04
 ...
 * @return {URL}
 */
function fixLocalHostToSiteHost(inputHost, searchHost = SEARCH_HOST, newHost = CND_HOST) {
  try {
  ...
  document.addEventListener(
    ...
    (e) => {
      ...
      if (elem.tagName.toLowerCase() === "img") {
        ...
        const newSrc = fixLocalHostToSiteHost(elem.src, SEARCH_HOST, CND_HOST);
